...
const GRADES = [
    ...
    "ม.1", "ม.2", "ม.3", "ม.4", "ม.5", "ม.6", "สอบเข้า ม.1",
    "ปวช.", "ปวส.", "มหาวิทยาลัย"
];
...
const QUESTION_STYLES = [
    ...
    { value: "m1_gov", label: "สอบเข้า ม.1 โรงเรียนรัฐบาล", description: "เน้นวัดความรู้พื้นฐานและการประยุกต์เบื้องต้น" },
    { value: "m1_gifted", label: "สอบเข้าห้อง Gifted", description: "เน้นโจทย์แข่งขัน ซับซ้อนและวิเคราะห์เชิงลึก" },
  ...
  "questions": [
    {
      ...
      "key_concept": "ระบุหลักการและเทคนิคการทำโจทย์ข้อนี้โดยย่อ (ก่อนเริ่มวิธีทำ)",
      "step_by_step_solution": [
        "ขั้นที่ 1: ...",
        "ขั้นที่ 2: ..."
      ],
      "common_mistakes": "ระบุจุดที่ควรระวังหรือจุดอันตราย (หลังจบวิธีทำ)"${isGeometry ? ',\n      "graphic_code": "<svg>...</svg>"' : ''}
    }
  ]
}`;
            specificInstructions = `คำสั่งกำกับพิเศษ (Strict Requirements):
1. **Key Concept (หลักการและเทคนิค)**: ต้องเริ่มด้วยการบอกหลักการพื้นฐานและเทคนิคในการแก้โจทย์ข้อนี้เสมอ (ห้ามปล่อยว่าง)
2. **Step-by-step**: แสดงวิธีทำละเอียดเป็นขั้นตอน
3. **Common Mistakes (ข้อควรระวัง)**: เมื่อจบวิธีทำ ต้องสรุปจุดที่นักเรียนมักพลาดหรือจุดอันตรายให้ด้วย
...
${specificInstructions}
ข้อควรระวัง: สัญลักษณ์ทางคณิตศาสตร์ทั้งหมดต้องใช้รูปแบบ LaTeX (ห้ามใช้ Backticks \` ครอบสมการเด็ดขาด ให้ใช้เฉพาะ $...$ หรือ $$...$$ เท่านั้น)`;
